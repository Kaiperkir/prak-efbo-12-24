...
// ==========================================
// 1. ХРАНИЛИЩА (База данных в памяти)
// ==========================================
let users = [];
...
app.use(cors({
    origin: "http://localhost:5173", // Изменил на порт Vite
...
// ==========================================
// 6. МАРШРУТЫ: ТОВАРЫ (Из твоей 2-й практики)
// ==========================================

// Открытые маршруты (для всех, даже гостей)
...
// Создание товара (Только Продавец и Админ) + Загрузка фото
...
// Обновление товара (Только Продавец и Админ)
